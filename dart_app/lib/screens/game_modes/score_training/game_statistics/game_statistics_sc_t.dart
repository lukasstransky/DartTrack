...
import 'package:dart_app/screens/game_modes/score_training/game_statistics/local_widgets/game_stats_score_training/game_stats_sc_t.dart';
import 'package:dart_app/screens/game_modes/score_training/game_statistics/local_widgets/game_stats_score_training/player_names_sc_t.dart';
...
class GameStatisticsScoreTraining extends StatefulWidget {
  static const routeName = '/statisticsScoreTraining';

  const GameStatisticsScoreTraining({Key? key}) : super(key: key);

  @override
  State<GameStatisticsScoreTraining> createState() =>
      _GameStatisticsScoreTrainingState();
}

class _GameStatisticsScoreTrainingState
    extends State<GameStatisticsScoreTraining> {
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: PlayerNamesScoreTraining(
