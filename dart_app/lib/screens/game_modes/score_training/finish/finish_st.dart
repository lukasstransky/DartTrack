...
class Finish_st extends StatefulWidget {
  static const routeName = '/finishScoreTraining';

  const Finish_st({Key? key}) : super(key: key);

  @override
  State<Finish_st> createState() => _Finish_stState();
}

class _Finish_stState extends State<Finish_st> {
  @override
  void initState() {
