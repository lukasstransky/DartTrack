...
import 'package:dart_app/other/custom_appbar_finished_gamex01.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:sizer/sizer.dart';
import 'dart:developer';

class FinishX01Screen extends StatelessWidget {
  static const routeName = "/finishX01";

  const FinishX01Screen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBarGameX01Finished("Finished Game"),
      body: Center(
        child: Container(
          width: 90.w,
          child: Column(
