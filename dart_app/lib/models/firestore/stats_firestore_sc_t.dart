...
class StatsFirestoreScoreTraining_P with ChangeNotifier {
  ...
  // player stats
  List<PlayerGameStatsScoreTraining> _allPlayerGameStats = [];
  ...
  List<PlayerGameStatsScoreTraining> get allPlayerGameStats =>
      this._allPlayerGameStats;
  set allPlayerGameStats(List<PlayerGameStatsScoreTraining> value) =>
