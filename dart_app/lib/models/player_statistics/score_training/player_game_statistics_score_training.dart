...
class PlayerGameStatisticsScoreTraining extends PlayerOrTeamGameStatistics
    implements Comparable<PlayerGameStatisticsScoreTraining> {
  int _currentScore = 0;
  List<int> _allScores = [];
  ...
  PlayerGameStatisticsScoreTraining.Firestore({
  ...
  PlayerGameStatisticsScoreTraining({
    required Player player,
    required String mode,
    required DateTime dateTime,
  ...
  @override
  int compareTo(PlayerGameStatisticsScoreTraining other) {
